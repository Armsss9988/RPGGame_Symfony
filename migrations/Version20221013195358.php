 ...
 */
final class Version20221013195358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game_type ADD category INT NOT NULL, DROP category_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON game_type');
        $this->addSql('ALTER TABLE game_type ADD category_id INT DEFAULT NULL, DROP category');
