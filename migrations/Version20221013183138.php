 ...
 */
final class Version20221013183138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_type (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, category_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_67CB3B05E48FD905 (game_id), UNIQUE INDEX UNIQ_67CB3B0512469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
